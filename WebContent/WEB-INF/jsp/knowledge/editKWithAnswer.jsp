...
<script type="text/javascript">
	...
	var ue1 = UE.getEditor('answerEditor');
	
	var content = '${k.content }';
	var answerContent = '${k.answerContent }';
	...
	ue1.ready(function() {
		ue1.setContent(answerContent);
	});
	
	function submitForm(){
		document.getElementById('content').value = UE.getEditor('editor').getContent();
		
		document.getElementById('answerContent').value = UE.getEditor('answerEditor').getContent();
    	return true;	 
	}
